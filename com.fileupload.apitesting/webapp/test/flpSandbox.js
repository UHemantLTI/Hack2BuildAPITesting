		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comfileuploadapitesting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comfileuploadapitesting-display": {
								"semanticObject": "comfileuploadapitesting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.fileupload.apitesting",
									"url": sap.ui.require.toUrl("com/fileupload/apitesting")
								}
							}
						}
					}
